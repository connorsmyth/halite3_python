...
class Position:
    ...
    def get_surrounding_cardinals_and_directions(self):
        positions =  [self.directional_offset(current_direction) for current_direction in Direction.get_all_cardinals()]
        return zip(positions, Direction.get_all_cardinals())
